...
class MaxMinusTest {
    ...
    fun testMax() {
        //
        assertEquals(MaxMinus().max("5 1 9 5"),9)
        //
        assertEquals(MaxMinus().max("7 5 3"),7)
        //
        assertEquals(MaxMinus().max("2 4 6 8"),8)
    }

    @Test
    fun testMaxMinMin() {
        //
        assertEquals(MaxMinus().maxMinMin("5 1 9 5"),8)
        //
        assertEquals(MaxMinus().maxMinMin("7 5 3"),4)
        //
